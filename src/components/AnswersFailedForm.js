...
class AnswersFailedForm extends Component {
  ...
  componentDidMount() {
    axios.get('http://192.168.1.138:1111/getFailedRandomQuestions')
    .then((result)=> {
      this.setState({
        answers: result.data
      });
            ...
            <div className='container'>
              <div className='row'>
                <div className='col-12'>
                  <h1>Todas las preguntas falladas</h1>
                </div>
              </div>
...
export default AnswersFailedForm;
